    ...
    <div className="w-full  py-16 ">
      <div className="flex flex-col items-start  md:w-9/12">
        ...
        <p className="text-black pr-16  text-[16px] mt-8">
          ...
          and activities to help you listen and respond with confidence in a
          safe and inclusive learning environment.
        </p>
        <br />
        <p className="text-black pr-20  text-[16px] ">
          Practice listening to your classmates in live group classes, get
          listening support from a personal tutor in one-to-one lessons or
