  ...
  return (
    <div className="lg:w-[67%]  mx-auto py-12 lg:py-16 flex flex-col items-center text-black">
      <p className="text-justify md:text-center my-4">
        Here you can find activities to practise your writing skills. Writing
      ...
      <p className="text-justify my-4">
        ...
        interactive exercises that practise the writing skills you need to do
      ...
      <p className="text-justify my-4">
        ...
        level (advanced), and improve your writing skills at your own speed,
