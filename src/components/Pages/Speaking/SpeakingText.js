...
const SpeakingText = () => {
  return (
    <div className="lg:w-[67%]  mx-auto py-12 lg:py-16 flex flex-col items-center text-black">
      <p className="text-justify md:text-center my-4">
        Here you can find activities to practise your speaking skills. Speaking
      ...
      <p className="text-justify my-4">
        ...
        interactive exercises that practise the speaking skills you need to do
      ...
      <p className="text-justify my-4">
        ...
        Select your level, from A1 English level (elementary) to C1 English
        level (advanced), and improve your speaking skills at your own speed,
